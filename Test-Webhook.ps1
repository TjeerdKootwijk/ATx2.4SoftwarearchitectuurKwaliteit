...
# Convert to JSON WITHOUT formatting (no extra spaces/newlines)
$Payload = $PayloadObj | ConvertTo-Json -Compress

# Calculate HMAC on this exact string
...
try {
    ...
    Write-Host "DEBUG - Payload sent: $Payload" -ForegroundColor Yellow
}
...
# Convert to JSON WITHOUT formatting (no extra spaces/newlines)
$Payload2 = $PayloadObj2 | ConvertTo-Json -Compress
...
try {
    ...
    Write-Host "Message: $($_.Exception.Message)" -ForegroundColor Red
    # Debug: show what was sent
    Write-Host "DEBUG - Payload sent: $Payload2" -ForegroundColor Yellow
}
